...
CALL ReadConsoleA@20 ; обратите внимание: LENS больше числа введенных символов на два, 
					 ;дополнительно введенные символы: 13 – возврат каретки и 10 – переход на новую строку
...
PUSH OFFSET BUF
CALL wsprintfA
ADD	ESP, 12; очистка стека от параметров (изменение регистра ESP на 3*4 = 12 байтов)
